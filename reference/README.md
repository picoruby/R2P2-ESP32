# R2P2-ESP32 参考資料・解説ドキュメント

⚠️ **このディレクトリは参考資料・解説ドキュメント集です**
- **公式ドキュメントではありません**
- プロジェクトの理解を支援するための補助資料です
- 実装の詳細解説や学習用途に活用してください

---

このディレクトリには、R2P2-ESP32 プロジェクトの詳細な技術解説書と、Claude Web Chat で使用できるプロンプトが保管されています。
...
**🤖 Claude Web Chat 用プロンプト（参考資料）**

Claude AI を活用して、さらに詳細な解説を生成するためのプロンプトです。
...
このディレクトリ（`reference/`）に含まれるすべてのドキュメントは：

✅ **参考資料・解説ドキュメントです**
- プロジェクト本体の補助資料です
- 公式ドキュメントではありません
- 学習・理解支援用途です
- 実装の詳細を理解したい時に活用してください

❌ **公式仕様ではありません**
- 実装の真実のソースは、プロジェクトのソースコード自体です
- 仕様確認が必要な場合は、公式リポジトリを参照してください
- 不正確な点があった場合は、ソースコードが正です
